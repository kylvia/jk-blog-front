      ...
      <el-row>
        <el-col :span="24">
          <div class="grid-title">
            <h3 class="articleTit" @click="toDetail(item.id)"><div class="article-type" :class="'type'+item.articleType">{{item.articleType | typeFilter}}</div>{{item.title}}</h3>
            <div class="rows">
              ...
              <svg-icon class="listIcon" iconClass="ydl"></svg-icon>{{item.pageviews}}{{item.id}}&nbsp;
            </div>
            <div class="contentShort"><div class="imgContent"><img src="/static/images/13.jpg" alt=""></div>{{item.content_short}}</div>
          </div>
        </el-col>
      </el-row>
    </div>
